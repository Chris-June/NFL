...
// Import 49ers specific data
import { ninersData as teamInfo } from "../data/Conference/NFC/West/49ers";
import { currentRoster } from "../data/Conference/NFC/West/49ers/currentRoster";
import { achievements } from "../data/Conference/NFC/West/49ers/achievements";
import { allTimeStats } from "../data/Conference/NFC/West/49ers/allTimeStats";
import { historicalStats } from "../data/Conference/NFC/West/49ers/historicalStats";
import { superBowlDetails } from "../data/Conference/NFC/West/49ers/superBowlDetails";
import { conferenceChampionships } from "../data/Conference/NFC/West/49ers/conferenceChampionships";
import { mascots } from "../data/Conference/NFC/West/49ers/mascots";

export function NinersPage() {
